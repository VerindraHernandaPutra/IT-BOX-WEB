...
<body>
    ...
    <div class="main-section auth-container" style="padding-top: 110px; padding-bottom: 110px;">
        <!-- Form Container -->
                        ...
                        <div id="registerForm" class="form-content active">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <label class="form-check-label" for="terms">Saya menyetujui <a href="#" class="text-decoration-none">Syarat & Ketentuan</a></label>
                                </div>
