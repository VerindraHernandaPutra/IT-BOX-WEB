    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h2>Edit Material for {{ $course->course_name }}</h2>
            </div>
            <div class="card-body">
                <form action="{{ route('materials.update', [$course->id, $material->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label class="form-label">Topic</label>
                        <input type="text" name="topic" class="form-control" value="{{ $material->topic }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">YouTube Video URL</label>
                        <input type="url" name="video_url" class="form-control" value="{{ $material->video_url }}" required>
                    </div>
