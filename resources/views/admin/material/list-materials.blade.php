    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h2>Materials for {{ $course->course_name }}</h2>
                <a href="{{ route('materials.create', $course->id) }}" class="btn btn-primary float-end">Add Materials</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach($materials as $key => $material)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('materials.edit', [$course->id, $material->id]) }}" class="btn btn-sm btn-warning text-white">Edit</a>
                                        <form action="{{ route('materials.destroy', [$course->id, $material->id]) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
